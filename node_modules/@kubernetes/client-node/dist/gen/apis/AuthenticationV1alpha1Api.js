...
export class AuthenticationV1alpha1ApiRequestFactory extends BaseAPIRequestFactory {
    ...
    async createSelfSubjectReview(body, dryRun, fieldManager, fieldValidation, pretty, _options) {
        ...
        const serializedBody = ObjectSerializer.stringify(ObjectSerializer.serialize(body, "V1alpha1SelfSubjectReview", ""), contentType);
...
export class AuthenticationV1alpha1ApiResponseProcessor {
    ...
    async createSelfSubjectReviewWithHttpInfo(response) {
        ...
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body = ObjectSerializer.deserialize(ObjectSerializer.parse(await response.body.text(), contentType), "V1alpha1SelfSubjectReview", "");
