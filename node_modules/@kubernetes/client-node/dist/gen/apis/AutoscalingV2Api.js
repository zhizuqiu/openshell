...
export class AutoscalingV2ApiRequestFactory extends BaseAPIRequestFactory {
    ...
    async createNamespacedHorizontalPodAutoscaler(namespace, body, pretty, dryRun, fieldManager, fieldValidation, _options) {
        ...
        const serializedBody = ObjectSerializer.stringify(ObjectSerializer.serialize(body, "V2HorizontalPodAutoscaler", ""), contentType);
     ...
     * @param body
     */
    async deleteNamespacedHorizontalPodAutoscaler(name, namespace, pretty, dryRun, gracePeriodSeconds, ignoreStoreReadErrorWithClusterBreakingPotential, orphanDependents, propagationPolicy, body, _options) {
        var _a;
        let _config = _options || this.configuration;
...
export class AutoscalingV2ApiResponseProcessor {
    ...
    async createNamespacedHorizontalPodAutoscalerWithHttpInfo(response) {
        ...
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body = ObjectSerializer.deserialize(ObjectSerializer.parse(await response.body.text(), contentType), "V2HorizontalPodAutoscaler", "");
    ...
    async listHorizontalPodAutoscalerForAllNamespacesWithHttpInfo(response) {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body = ObjectSerializer.deserialize(ObjectSerializer.parse(await response.body.text(), contentType), "V2HorizontalPodAutoscalerList", "");
            return new HttpInfo(response.httpStatusCode, response.headers, response.body, body);
        }
        if (isCodeInRange("401", response.httpStatusCode)) {
            throw new ApiException(response.httpStatusCode, "Unauthorized", undefined, response.headers);
