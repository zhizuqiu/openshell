...
export class AutoscalingV1ApiRequestFactory extends BaseAPIRequestFactory {
    ...
    async createNamespacedHorizontalPodAutoscaler(namespace, body, pretty, dryRun, fieldManager, fieldValidation, _options) {
        ...
        const serializedBody = ObjectSerializer.stringify(ObjectSerializer.serialize(body, "V1HorizontalPodAutoscaler", ""), contentType);
...
export class AutoscalingV1ApiResponseProcessor {
    ...
    async createNamespacedHorizontalPodAutoscalerWithHttpInfo(response) {
        ...
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body = ObjectSerializer.deserialize(ObjectSerializer.parse(await response.body.text(), contentType), "V1HorizontalPodAutoscaler", "");
    ...
    async listHorizontalPodAutoscalerForAllNamespacesWithHttpInfo(response) {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body = ObjectSerializer.deserialize(ObjectSerializer.parse(await response.body.text(), contentType), "V1HorizontalPodAutoscalerList", "");
            return new HttpInfo(response.httpStatusCode, response.headers, response.body, body);
        }
        if (isCodeInRange("401", response.httpStatusCode)) {
            throw new ApiException(response.httpStatusCode, "Unauthorized", undefined, response.headers);
